...
class StrategyLoader:
    ...
    def init(this):
        ...
        C.max_param = C._param.get('max_param', '')
        if type(C.max_param) == int:
            C.max_param = {
                0               :'tick'
                , 60000         :'1m'
                , 180000        :'3m'
        ...
        if 1: #post initcomplete
            ...
            quote_ar = [
                'stock_code', 'stockcode', 'market', 'max_param'
    ...
    def load_main_history(this):
        ...
        data = xtdata.get_market_data_ex(
            field_list = ['time'], stock_list = [C.stock_code], period = C.max_param
    ...
    def load_main_realtime(this):
        ...
        this.main_quote_subid = xtdata.subscribe_quote(
            stock_code = C.stock_code, period = C.max_param
    ...
    def create_view(this, title):
        C = this.C
        client = xtdata.get_client()
        data = {'viewtype': 0,'title':title, 'groupid':-1,'stockcode':C.market + C.stockcode,'max_param':C.max_param}
